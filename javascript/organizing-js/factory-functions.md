...
- Explain how scope works in JavaScript (bonus points if you can point out what ES6 changed!)./paths/foundations/courses/foundations/lessons/dom-manipulation-and-events
